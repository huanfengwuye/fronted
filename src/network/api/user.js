...
///	查询用户印花
export function getUserSticker()
{
		return axios( {
...
/// 获取签到奖项
export function getSigninAwards()
{
		return axios( {
				url : '/api/user/signinAwards',
				method : 'get',
		} )
}
...
/// 获取签到奖项记录
export function getSigninRewardRecords()
{ 
		return axios( {
				url : '/api/user/signinRewardRecords',
				method : 'get',
		} )
}

/// 用户点亮印花
export function activateSticker(data)
{ 
		return axios( {
				url : '/api/user/activateSticker',
				method : 'post',
				data
		} )
}
...
/// 用户兑换印花奖励
export function stickerReward(data)
{ 
		return axios( {
...
{ 
		return axios( {
				url : '/api/user/registerReward',
				method : 'post',
		} )
}

/// 用户转换物品为材料
export function markRucksackMaterial(data)
{ 
		return axios( {
				url : '/api/user/markRucksackMaterial',
				method : 'post',
				data
		} )
}
...
/// 用户获取背包材料
export function getRucksackMaterials(data)
{ 
		return axios( {
				url : '/api/user/getRucksackMaterials',
				method : 'post',
				data
		} )
}
...
/// 用户打开背包红包
export function openReward(data)
{ 
		return axios( {
				url : '/api/user/openReward',
				method : 'post',
				data
		} )
}