...
<template>
    ...
    >
        ...
        >
            ...
            <!-- <div class="nav_btn">
                <div class="nav_btn_mall" @click="jump('/m/mall')">弹壳商城</div>
                <div class="nav_btn_recharge" @click="jump('/m/recharge')">
                    充值
                </div>
            </div> -->
            ...
            <div class="nav_item" @click="onH5ClickExitLogin()">
                <img src="@/assets/romimg/header/logout.png" />
                {{ t( 'menu.logout' ) }}
                <span class="icon iconfont">&#xe61e;</span>
            </div>
            <!-- 
                ...
                <div class="check-main">
                    ...
                    <div v-for="(item, index) in awardsList" :key="index" class="check-item">
                        ...
                        <div class="item-body" :class="{active: shouldHighlight(index)}" v-if="index !== 6">
                            ...
                            <!-- 根据条件决定是否显示印章 -->
                            <img v-if="shouldShowStamp(index)" class="stamp" :class="{'active': shouldShowActiveStamp(index)}" src="@/assets/pcimg/common/stamp-active.png" alt="">
                            ...
                            <!-- 如果是实物奖励，显示价格 -->
                            <Price v-if="item.goodsType === 1" size="15" font-weight="700" color="#A25A1B" :currency="item.price"></Price>
                    ...
                    <div class="check-7">
                        ...
                        <img v-if="!shouldShowRandomAmount(6)" :src="lastItem.iconUrl" alt="">
                        <img v-if="shouldShowRandomAmount(6)" src="@/assets/pcimg/newYear/question.png" alt="">
                    </div>
                </div>
...
#top-header {
    ...
    .check-bg{
        ...
        .check-body{
            ...
            background: url( @/assets/romimg/header/check-bg-active.png ) no-repeat;
            ...
            .check-main{
                ...
                background: rgba(255, 98, 81, 0.20);
                ...
                .check-7{
                    ...
                    height: 180px;
                    // background: #1C1F39;
                    background: linear-gradient(110deg, #FFDFA4 2.64%, #FFC777 36.71%);
                    border-radius: 12px;
                    bottom: 30px;
                    left: 36px;
                    gap: 20px;
