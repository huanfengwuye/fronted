	...
	<div id="h5-show-dialog" class="popup" :class="{ active: props.show }">
		<div class="popup-wrap">
			...
			<div class="popup-title">
				...
				<div
					v-if="title_register === '账号注册' || title_register === '账号登陆'"
					class="pop-title-top-register"
					:class="{ active: !registerShow }"
					@click="onClickSign"
				>
					{{ title }}
				</div>
			...
			<div class="popup-content">
				...
				<div v-else-if="btnType == 2">
					...
					<div
						v-if="prompt_show"
						:class="{ active: tipsChecked }"
						class="popup-tips-wrap"
						@click="onClickTips"
					>
						<img
							v-if="!tipsChecked"
							src="@/assets/romimg/common/unselected1.png"
							alt=""
						/>
				...
				<div class="popup-btn-wrap" v-else-if="btnType == 3">
					...
					<div class="popup-sure-btn huishou" @click="ok()">
						<span class="icon iconfont">&#xe665;</span>炼化
