...
const needToken = ['/m/roll_detail', '/m/contract', '/m/createbattle', '/m/battleBoxDetails'
	, '/m/battleHistory',	 '/m/battleDetail', '/m/recharge', '/m/personal'
	, '/m/bag', '/m/record', '/m/spread', '/m/information', '/m/informationDetail',"/m/vip", "/p/createbattle"];

const needReserve = ['/m/battle', '/m/battle/list','/m/createbattle', '/m/battleBoxDetails', '/m/battleHistory', '/m/rank', '/m/battleDetail'];

const notShowFooter = ['/m/createbattle','/m/activity','/p/activity','/m/reserve'];
const notShowHeader = ['/m/createbattle','/m/activity','/p/activity','/m/reserve'];
