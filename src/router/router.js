	...
	},
	{
		...
		children: [
			...
			//开箱页面
			{
				path: "openbox",
				name: "m_openbox",
				component: () => import("@/views/openbox/h5/openbox.vue"),
				meta: {
					name : 'openbox'
				},
			},
			//开箱页面
			{
				path: "reserve",
				name: "m_reserve",
				component: () => import("@/views/reserve/h5/reserve.vue"),
				meta: {
					name : 'reserve'
				},
			},
			...
			//饰品置换
			{
				path: "replacement",
				name: "m_replacement",
				component: () => import("@/views/replacement/h5/replacement.vue"),
				meta: {
					name: "replacement",
					type: "user",
				},
			...
			// 	path: "turntable",
			// 	name: "m_turntable",
			// 	component: () => import("@/views/turntable/h5/turntable.vue"),
			// 	meta: {
			// 		name: "turntable", 
			// 	},
			// },
			//任务系统
			{
				path: "task",
				name: "m_task",
				component: () => import("@/views/pages/task/h5/task.vue"),
				meta: {
					name: "task",
				},
			},
			...
			// 	path: "refining",
			// 	name: "m_refining",
			// 	component: () => import("@/views/refining/h5/refining.vue"),
			// 	meta: {
			// 		name: "refining",
			// 	},
			// },
			//新年活动
			{
				path: "newyear",
				name: "m_newyear",
				component: () => import("@/views/newyear/h5/newyear.vue"),
				meta: {
					name: "newyear",
				},
			},
			...
			},
			{
				path: 'activity',
				name : 'm_activity',
				component: () => import( '@/views/activity/h5/activity.vue' ),
				meta : {
					name : 'activity'
				}
			},
			...
			},
			{
				 path: "rank",
				 name: "m_battle_rank",
				 component: () => import("@/views/pages/rank/h5/rank.vue"),
				 meta: {
					 name: t("router.battleRank"),
				 },
			},
			// {
			// 	 path: "battleHistory",
		...
		
		{
			...
			//账户充值
			{
				...
				meta: {
					name: t("recharge.onlineRecharge"),
					type: "user",
				},
			},
			//个人资料
			...
			//个人资料
			{
				path: "bag",
				name: "m_bag",
				component: () => import('@/views/pages/me/h5/bag.vue'),
				meta: {
					name: "myBag",
					type: "user",
				},
			...
			//帮助中心
			{
				...
				children: [
					...
					},
					{
						path: "notarized",
						name: "m_notarized",
						component: () => import("../views/h5/help/subpage/Notarized.vue"),
						meta: {
							name: "notarized",
						},
					},
	...
	},
	{
		...
		children: [
			...
			/// rank
			{
				path : 'rank',
				name : 'p_rank',
				component : () => import( '@/views/pages/rank/pc/rank.vue' ),
				meta :
				{
					name : 'rank'
				}
			...
			// 	path: "refining",
			// 	name: "p_refining",
			// 	component: () => import("@/views/refining/pc/refining.vue"),
			// 	meta: {
			// 		name: "refining",
			// 	},
			// },
			...
			//开箱页面
			{
				...
				name: 'p_openbox',
				component: () =>
					import('@/views/openbox/pc/openbox.vue'),
				meta: {
					name: 'openbox'
				}
			},
			...
			//任务系统
			{
				path: "task",
				name: "p_task",
				component: () => import("@/views/pages/task/pc/task.vue"),
				meta: {
					name: "task",
				},
			},
			//新年活动
			{
				path: "newyear",
				name: "p_newyear",
				component: () => import("@/views/newyear/pc/newyear.vue"),
				meta: {
					name: "newyear",
				},
			},
			...
			},
			{
				path: "replacement",
				name: "p_replacement",
				component: () => import("@/views/replacement/pc/replacement.vue"),
				meta: {
					name: "replacement",
					type: "user",
				},
			...
			
			{
				 path: "activity",
				 name: "p_activity",
				 component: () => import("@/views/activity/pc/activity.vue"),
				 meta: {
					 name: "activity",
				 },
			},
			//个人中心
			{
				...
				children: [
					...
					//背包
					{
						...
						name: 'p_bag',
						component: () =>
							import('@/views/pages/me/pc/bag.vue'),
						meta: {
							name: 'myBag',
							type: 'user'
						}
					...
					//帮助中心
					{
						...
						children: [
							...
							},
							{
								...
								name: 'p_notarized',
								component: () =>
									import('@/views/pc/me/help/subpage/Notarized.vue'),
								meta: {
									name: 'notarized'
								}
							},
