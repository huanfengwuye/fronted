...
const state = {
	...
	showRealnameView: false,	///	显示实名认证弹窗
...
const mutations = {
	...
	///	实名认证
	setRealnameView( state, data )
	{
		state.showRealnameView = data
	},
	...
	setRegPacket(state, data) {
		...
		state.regPacket.skinsUrl = data.skinsUrl
		state.regPacket.name = data.name
		state.regPacket.grade = data.grade
	},
