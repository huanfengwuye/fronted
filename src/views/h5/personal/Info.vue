...
function openUrl()
{
	open("https://steamcommunity.com/login/home/?goto=%2Fid%2Fme%2Ftradeoffers%2Fprivacy#trade_offer_access_url",'_self')
}
	...
	<div id="personal-info">
		...
		<div class="row-wrap">
			...
			<div v-else class="value" @click="goToEdit('realName')">
				{{ t('users.noRealnameTitle') }}<span class="icon iconfont">&#xe651;</span>
			</div>
		</div>
		...
		<div class="switch-wrap">
			...
			<div class="jump-link" @click="openUrl"> 
				{{ t( 'users.jumpSteamLink' ) }}
			</div>
		</div>
