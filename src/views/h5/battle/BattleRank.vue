	...
	<div class="rank-wrap">
	  ...
	  >
		<div class="item-info">
		  <span class="no"
			>{{
			  rankData.myRankItem.rankNum > 10 ||
		...
		<div class="point">
		  {{ rankData.myRankItem.point == "" ? 0 : parseInts(rankData.myRankItem.point) }}
		</div>
		<div class="balance" style="padding-left: 0px">
		  <div class="next-desc">{{ t( 'rank.onListTip' ) }}</div>
		  <div class="next-point" v-if="parseInt(rankData.items[rankData.items.length - 1].point) -
				  parseInt(rankData.myRankItem.point) > 0">
			{{
