...
<template>
	<div id="pc-box-result" :class="{ active: show }">
		<div class="mult-result-wrap" v-if="goodList.length > 1">
			...
			<div class="opt-wrap">
				<div class="btn-all-recovery" @click="onClickSellMakings">
					全部炼化
					<!-- <img
						class="pc-price-coin"
				...
				<div class="btn-recovery" @click="onClickSellMakings">炼化选择的饰品</div>
		...
		<div class="one-result-wrap dialog-wrap" v-if="goodList.length == 1">
			...
			<div class="opt-wrap">
				<div class="btn-return" @click="onClose">放入背包</div>
				<div class="btn-recovery" @click="onClickSellMakings">
					炼化<img
						class="pc-price-coin"
						src="@/assets/pcimg/common/coin.png"
						alt=""
