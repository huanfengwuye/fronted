	...
	<div id="luckyboxdetails">
		...
		<div class="big_bg">
			...
			<div class="rate-wrap">
				...
				<div class="rate-progress-wrap">
					...
					<div class="left-wrap">{{ t('openbox.probabilityOfSuccess') }}</div>
					<div class="slide">
				...
				<div class="drop-wrap">
					...
					>
						<div class="list-head">
							...
							<div class="per">{{ t('common.probability') }}</div>
						...
						<div class="drop-list">
							...
							>
								<div class="drop-jj-item-wrap" :class="{ active: !item.isWin }">
									<div class="head">
										<!-- <H5Avatar :userModel="item" :size="'one'"></H5Avatar> -->
		...
		<!-- <div class="history-wrap">
			...
			<div class="drop-wrap" v-if="!historyShowDetails">
				...
				>
					<div class="per">{{ item.probability }}%</div>
					<H5Avatar :userModel="item" :size="'open'"></H5Avatar>
					<p class="hide">{{ item.goodsName }}</p>
					<div class="goods-wrap">
						<img v-if="item.isWin" :src="item.iconUrl" alt="" />
						<img :src="item.rewardIconUrl" alt="" />
		...
		<div class="search-wrap" :class="{ active: searchShow }">
			...
			<div class="input-wrap">
				<div class="title">{{ t('common.probability') }}</div>
				<div class="content">
					<input
