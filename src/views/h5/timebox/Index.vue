	...
	<div id="timingbox" class="min-wrap-height">
			...
			<div class="time_list">
				<div class="timing-item week-bg" v-if="week.type">
					<div class="timing-item-wp">
						...
						<div class="time-goods-join week" v-if="week.isJoined">{{ t('timebox.joined') }}</div>
				...
				<div class="timing-item hour-bg" v-if="hour.type">
					...
					<div class="timing-item-info">
						...
						<div class="count-time-wrap">
							<p v-html="t( 'timebox.rechargeText', { type : t( 'timebox.everyHour' ), money : hour.needAmount } )"></p>
		...
		<div class="drop-list">
			...
			>
				...
				<div class="bottom">
					<p>
						<H5Avatar :userModel="item" :size="'timing'"></H5Avatar>
					</p>
					<div class="right">
