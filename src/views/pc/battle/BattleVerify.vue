									...
									<div class="detail-wrap">
										...
										<div class="user-wrap">
											<div class="user-item" v-for="(item, index) in result?.users" :key="index">
												<Avatar :userModel="item" :size="'pc_e_head_fourten'"></Avatar>
												...
												<div class="item-content">
													<div class="item-user" v-for="element in item" :key="element.goodsId">
														...
														<div class="round-user-content">
															<div>
																{{ element.position
																}}<span @click="onClickVerify(element.position)">[{{ t( 'battle.verify' ) }}]</span>
															</div>
							...
							<div v-show="activeTab == 2" class="content-wrap">
								<div class="verify-wrap">
									...
									<div class="verify-item">
										...
										<input type="text" :placeholder="t( 'battle.enterValue' )" readonly v-model="randValue" />
									</div>
									<div class="verify-item">
										<p>{{ t( 'battle.seatNo' ) }}</p>
										<input type="text" :placeholder="t( 'battle.enterSeatNo' )" v-model="position" @input="valueChange" />
									</div>
									<div class="verify-result" v-html="t( 'battle.rewardNo', { pos : position, result : currentSeriaNum } )"></div>
								</div>
							</div>
						</div>
					</div>
