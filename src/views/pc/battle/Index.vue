		...
		<div class="pc-battle-body">
			<div class="pc-battle-title">
				...
				<div class="opts">
					<div class="opt" @click="onClickSort" v-if="false">
						<span class="icon iconfont pc-icon">&#xe61b;</span>{{ store.state.battleListSort == 1 ? t( 'common.defaultSort' ) : t( 'common.priceSort' ) }}
					</div>
			...
			<div class="swiper-container">
				...
				>
					...
					>
							<img class="img-bg" src="@/assets/pcimg/battle/pseudo.png" alt="">
