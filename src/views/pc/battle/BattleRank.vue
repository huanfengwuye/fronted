		...
		<div class="rank-wrap">
					...
					>
						...
						<div class="top-rank-item">
							...
							<div class="other-info">
								<Price show-icon font-weight="700" :value="item.sumScore" color="#71E3A0" before-size="27px" after-size="20px"></Price>
			...
			<div class="list-wrap">
				...
				<div v-for="(item, index) in otherRank" class="rank-item" :key="index">
					...
					<div class="item-user">
						<Avatar :userModel='item' :size="'pc-battle-header-small'" :hide-frame="true">
						</Avatar>
