				...
				<div class="create-body">
					<div class="search-container">
						...
						<div class="search-filter">
							<input type="text" v-model="searchTabData.searchFilter"
								:placeholder="t( 'battle.boxName' )" @keyup.enter="onSearchName()" />
					...
					<div class="goods-list">
						<div class="goods-item" v-for="(item, index) in listBox" :class="{ active: item.amount > 0 }"
							...
							<div class="price">
								<span class="iconfont pc-icon" style="font-size: 18px !important; margin-right: 5px">&#xe61c;</span>
