...
<template>
	<div id="pc-timingbox" class="min-wrap-height">
		<div class="page-head">
			...
			<div class="tabs">
				<div :class="{ tab : true, active : tabType == 1 }" @click="onClickTab( 1 )">{{ t( 'timebox.defaultBox' ) }}</div>
				<div :class="{ tab : true, active : tabType == 2 }" @click="onClickTab( 2 )" v-html="t( 'timebox.vip5Box' )"></div>
				<div :class="{ tab : true, active : tabType == 3 }" @click="onClickTab( 3 )" v-html="t( 'timebox.vip10Box' )"></div>
			...
			<div class="timing-list">
				<div class="timing-item" v-if="hour.type">
					<div class="left-bt-wrap">
						...
						<!-- <div class="price" v-if="!isAllowJoin( hour )"><img src="@/assets/pcimg/common/coin.png"> {{ joinNeedAmount( hour ) }}</div> -->
							<Price
								size="12"
								color="#B9DEE0"
								fontWeight="700"
								:currency="joinNeedAmount( hour )"
							></Price>
						<div class="state" @click="join">{{ hour.isJoined ? t( 'timebox.joined' ) : t( 'timebox.join' ) }}</div>
					</div>
					...
					<div class="time-goods-info">
						...
						<div class="pep-count">
							<!-- <img src="@/assets/pcimg/common/coin.png"> {{ hour.boxItem.price }} -->
							<Price
								size="16"
								color="#75DC9E"
								fontWeight="700"
						...
						<p class="item-rule text-cut" v-html="t( 'timebox.rechargeText', { type : t( 'timebox.everyHour' ), money : hour.needAmount } )"></p>
						<van-count-down :time="TimeFilter(1)" @finish="finish">
							<template #default="timeData">
								<div class="count-item">
									<div class="count-bk">
										<div class="split hour"></div>
										<label>{{ timeData.minutes >= 10 ? timeData.minutes : '0' + timeData.minutes }}</label>
									</div>
								...
								<div class="count-item">
									<div class="count-bk">
										<div class="split hour"></div>
										<label>{{ timeData.seconds >= 10 ? timeData.seconds : '0' + timeData.seconds }}</label>
									</div>
				...
				<div class="timing-item day" v-if="day.type">
					<div class="left-bt-wrap">
						...
						<!-- <div class="price" v-if="!isAllowJoin( day )"><img src="@/assets/pcimg/common/coin.png"> {{ joinNeedAmount( day ) }}</div> -->
							<Price
								size="12"
								color="#B9DEE0"
								fontWeight="700"
								:currency="joinNeedAmount( day )"
							></Price>
						<div class="state" @click="join">{{ day.isJoined ? t( 'timebox.joined' ) : t( 'timebox.join' ) }}</div>
					</div>
					<div class="timing-item-wp">
					...
					<div class="time-goods-info">
						...
						<div class="pep-count">
							<!-- <img src="@/assets/pcimg/common/coin.png"> {{ day.boxItem.price }} -->
							<Price
								size="16"
								color="#75DC9E"
								fontWeight="700"
						...
						<p class="item-rule text-cut" v-html="t( 'timebox.rechargeText', { type : t( 'timebox.everyDay' ), money : day.needAmount } )"></p>
				...
				<div class="timing-item week" v-if="week.type">
					<div class="left-bt-wrap">
						...
						<!-- <div class="price" v-if="!isAllowJoin( week )"><img src="@/assets/pcimg/common/coin.png"> {{ joinNeedAmount( week ) }}</div> -->
							<Price
								size="12"
								color="#B9DEE0"
								fontWeight="700"
								:currency="joinNeedAmount( week )"
							></Price>
						<div class="state" @click="join">{{ week.isJoined ? t( 'timebox.joined' ) : t( 'timebox.join' ) }}</div>
					</div>
					<div class="timing-item-wp">
					...
					<div class="time-goods-info">
						...
						<div class="pep-count">
							<!-- <img src="@/assets/pcimg/common/coin.png"> {{ week.boxItem.price }} -->
							<Price
								size="16"
								color="#75DC9E"
								fontWeight="700"
						...
						<p class="item-rule text-cut" v-html="t( 'timebox.rechargeText', { type : t( 'timebox.everyWeek' ), money : week.needAmount } )"></p>
			...
			<div class="pool-items">
				<div class="pool-item" v-for="(item, index) in recordList" :key="index">
					<div class="item-card">
						...
						<div class="user-wrap">
							<div class="user-info">
								<Avatar :userModel='item' :hideFrame="true" :size="'pc-openbox-header'">
								</Avatar>
							</div>
