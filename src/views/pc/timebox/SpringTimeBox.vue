...
<template>
	<div class="spring-time-bg" @click="onClickIcon">
				...
				<div class="count-time-wrap">
					...
					<van-count-down :time="TimeFilter()"	@finish="finish" ref="countDownRef">
						<template #default="timeData">
							...
							<div class="count-txt"> <span>时</span></div>
							<span class="count-bk">{{
								timeData.minutes >= 10 ? timeData.minutes : '0' +
									timeData.minutes
							}}</span>
							<div class="count-txt"> <span>分</span></div>
							<span class="count-bk">{{
								timeData.seconds >= 10 ? timeData.seconds : '0' +
									timeData.seconds
							}}</span>
							<div class="count-txt"> <span>秒</span></div>
						</template>
					</van-count-down>
