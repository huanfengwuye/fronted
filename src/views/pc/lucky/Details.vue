	...
	<div id="pc-luckyboxdetails">
		...
		<div class="lucky-detail-wrap">
			<div class="sound" @click="onClickSound">
				<img
					class="icon-sound"
					src="@/assets/pcimg/openbox/sound_open.png"
					v-if="!animationSound"
				/>
				<img
					class="icon-sound"
					src="@/assets/pcimg/openbox/sound_close.png"
					v-else
				/>
			</div>
			...
			<LuckyAni
				v-show="aniLayer"
				:title="getGoodsNameSec(curluckyGood.goodsName)"
				:sub-title="getGoodsNamePre(curluckyGood.goodsName)"
				:goodsList="goodsList"
			...
			<div class="lucky-section-container">
				<div class="lucky-section-item">
					...
					<div class="luck-item-container grid">
						<div
							class="sec-item"
							:class="{ choice: curluckyGood.id == item.id }"
							@click="onClickLuckyGood(item)"
							v-for="(item, index) in luckyGoodsItems"
							:key="index"
						>
							<div
				...
				<div class="lucky-section-item">
					<div class="section-header-container">
						...
						<div class="btn-group">
							<div
								class="btn"
								@click="dropPager.userType = 1"
								:class="{ active: dropPager.userType == 1 }"
							>
								{{ t( 'lucky.memberDrop' ) }}
							</div>
							<div
								class="btn"
								@click="dropPager.userType = 2"
								:class="{ active: dropPager.userType == 2 }"
							>
								{{ t( 'lucky.anchorDrop' ) }}
							</div>
						</div>
		...
		>
			<div class="count-select-container">
				<img
					src="@/assets/pcimg/common/close.png"
					class="close-count-select"
					@click="closeCountSelect()"
				/>
				...
				<div class="window-header-container">
					<div class="window-header">
						<div
							...
							:class="{ active: windowType == 'global' }"
	...
	.lucky-content-wrap {
		...
		.bar-wrap {
			...
			.bar-bottom {
				width: 300px;
				height: 4px;
				background: url(@/assets/pcimg/lucky/bar_point.svg) left center/auto 58%
					no-repeat #0d0e1d;
	...
	.lucky-bottom-wrap {
		.lucky-bottom {
			...
			&::before {
				...
				height: 578px;
				transform: translateX(-50%);
				background: url(@/assets/pcimg/lucky/bottom_bg.png) center bottom
					no-repeat;
			}
				...
				.luck-item-container {
					...
					&.grid {
						...
						.sec-item {
							...
							&.choice {
								background: url(@/assets/pcimg/openbox/choose.png) no-repeat
									center #15172c;
								background-size: 100% 100%;
