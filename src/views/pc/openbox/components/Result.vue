...
function showReuslt(list) {
	goodList.value = list;
	window.$dev && console.log("goodList.value>>>>>>>>>>>>>>>>>>>>>>>>>>>list")
...
<template>
	<div id="pc-openbox-result" :class="{ 'active': show }">
		...
		<div class="show_main" :class="[{ 'four': overall == 'four' }, { 'five': overall == 'five' }]">
			...
			<div class="title-data" v-if="props.titleData" v-html="t( 'openbox.getRewardContentPc', { name : props.titleData.name, price : props.titleData.price } )"></div>
			...
			<div class="result-btns">
				<!-- <p @click="onClickSellMa">{{ '炼化' }}{{ sellingPrice.toFixed(2) }}</p> -->
