...
async function getAttributes() {
	...
	if (res.code == 0) {
		...
		window.$dev && console.log("typeItems.value",typeItems.value)
...
async function getList() {
	...
	if (ammoArea.value.max != 0) {
		params.minPoint = Number(ammoArea.value.min) + "";
		params.maxPoint = Number(ammoArea.value.max) + "";
	}
	...
	if (res.code == 0) {
		...
		rucksackAmount.value = res.data.userPoint;
						...
						>
							...
							<div class="price">
								<!-- <img
									...
									alt=""
								/> -->
								<Icon name="diamond" :size="16"></Icon>&nbsp;
								{{ item.point }}
								<!-- <Price
									size="16"
									color="#75DC9E"
			...
			<div class="exchange-content-wrap">
				...
				<div class="price">
					<!-- <img
						...
						alt=""
					/> -->
					<Icon name="diamond" :size="26"></Icon>
					{{ exchangeSelItem.point }}
					<!-- <Price
						size="23"
						color="#75DC9E"
						fontWeight="700"
						:currency="exchangeSelItem.price"
					></Price> -->
				</div>
				<div class="goods-wrap">
					<div
						class="pic"
						:style="
							'background-image: url(' + getImageBg(exchangeSelItem) + ');'
						"
					>
						<img :src="exchangeSelItem.iconUrl" alt="" />
					</div>
					<div class="name hide">{{ getGoodsNamePre(exchangeSelItem.goodsName, 1) }}</div>
					<div class="name hide">{{ getGoodsNameSec(exchangeSelItem.goodsName, 1) }}</div>
				</div>
