...
import { getSpreadDetails, getStatsList } from "@/network/api/recharge";
...
async function getSpreadList() {
	...
	if (res.code == 0) {
		...
		console.log("statsList",statsList.value);
		loading.value = false;
		...
		<div class="top-info" v-if="false">
			...
			<div class="spread-cont flexCol">
				<div class="spread-item day-award-wrap" @click="onClickDayAward()">
					...
					<div class="f-row">
						<img
							class="spread-title-img"
							src="@/assets/romimg/spread/arrow_right.png"
							alt=""
						/>
					</div>
				</div>
				...
				<div class="spread-item">
					<div class="f-col">
						<div class="spread-item-info">
							<span>{{ t( 'users.mySpreadLink' ) }}：</span
			...
			<div class="spread-steps flexCol">
				<div class="spread-steps-item flexRow">
					<img
						class="spread-steps-titleImg"
						src="@/assets/romimg/spread/share.png"
						alt=""
					/>
				...
				<div class="spread-steps-item flexRow">
					<img
						class="spread-steps-titleImg"
						src="@/assets/romimg/spread/recharge.png"
						alt=""
					/>
					<div class="spread-steps-itemInfo f-col">
				...
				<div class="spread-steps-item flexRow">
					<img
						class="spread-steps-titleImg"
						src="@/assets/romimg/spread/bag.png"
						alt=""
					/>
					<div class="spread-steps-itemInfo f-col">
				...
				<img
					class="spread-steps-bg"
					src="@/assets/romimg/spread/big_bag.png"
					alt=""
				/>
			</div>
		</div>
