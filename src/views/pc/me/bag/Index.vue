	...
	<div id="pc-bag" @click.stop="onBaseClick">
		<div class="bag-header">
			...
			<div class="bag-header-r">
				<div class="btn-wrap" @click="$router.push( '/m/replacement' )">{{ '置换' }}
				...
				<div class="goods-list">
					<div class="goods-item" v-for="(item, index) in goodsList" :key="index" :class="{ 'active': item.choose }">
						...
						<div class="item-opt">
							...
							<div class="opt-item" v-if="item.statusType == 1" @click.stop="$router.push( '/m/replacement' )">{{ '置换' }}</div>
						</div>
					</div>
				</div>
			</List>
