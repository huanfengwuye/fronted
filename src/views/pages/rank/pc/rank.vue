				...
				<div class="intro">
					<div class="content" v-if="false">
						...
						<div class="count-down">
							...
							{{ overtime.min < 10 ? `0${overtime.min}` : overtime.min }} :
							{{ overtime.sec < 10 ? `0${overtime.sec}` : overtime.sec }}
						</div>
					</div>
				</div>
				<div class="ad">
					<div class="r-title" v-if="false"><img src="@/assets/pcimg/battle/coins-lg.png" alt=""/>{{ parseInts( rewardAmount ) }}</div>
					...
					<div class="rule-items">
						...
						<div class="time-day" @click="switchDay">
		...
		<div class="rank-wrap">
			...
			<div class="top-wrap">
				<div class="top-warp-fix">
					<BattleRankTopItem
						:rank="index + 1"
						v-for="( item, index ) in topRank" :key="index"
					>
						...
						<div class="top-rank-item">
							...
							<video class="fire" src="@/assets/pcimg/common/fire.webm" muted autoplay loop></video>
							<div class="user-info">
								<img :src="item.avater" class="user-avatar">
								<div>{{index + 1}}</div>
							</div>
							<div class="other-info">
				<!-- <div class="amount"><img src="@/assets/pcimg/common/coin.png" alt=""/> {{ parseInts( item.rewardAmount ) }}</div> -->
				<Price font-weight="700" size="27" :value="parseInts( item.rewardAmount )" color="#71E3A0"></Price>
				<div class="point">
				...
				<!-- <div class="top-item" v-for="(item, index) in topRank" :key="index"> -->
					<!-- <div class="award" :class="[{ two: index == 1, three: index == 2 }]">
						<Avatar :userModel='item' :size="'pc-battle-big-header'">
						</Avatar>
					</div>
					<div class="info-wrap">
			...
			<div class="list-wrap">
				<!-- <div class="rank-item me" v-if="false">
					...
					<div class="item-user">
						<Avatar :userModel='userInfoBase' :size="'pc-battle-header-small'" :hide-frame="true">
						</Avatar>
				...
				<div class="rank-item my-rank" v-if="hasLogin">
					<div class="item-rank">{{ ( myRank !== null && myRank.rankNum && myRank.rankNum < 10 ) ? myRank.rankNum : '10+' }}</div>
					<div class="item-user">
					...
					<div class="item-price no-warp" v-if="myRank && myRank.rankNum != 0 && myRank.rankNum <= 10">
						<!-- <img src="@/assets/pcimg/common/coin.png" alt=""/>{{ parseInts( myRank.rewardAmount ) }} -->
						<Price size="18" :value="parseInts( myRank.rewardAmount )" color="#71E3A0"></Price>
					</div>
				...
				<div v-for="(item, index) in otherRank" class="rank-item" :key="index">
					...
					<div class="item-user">
						<Avatar :userModel='item' :size="'pc-battle-header-small'" :hide-frame="true"></Avatar>
					...
					<div class="item-price">
						<Price size="18" :value="parseInts( item.rewardAmount )" color="#71E3A0"></Price>
...
#pc-battleRank {
	...
	.rank-header-container
	{
		...
		// background: url( @/assets/pcimg/battle/rank-header-bg-active.png ) no-repeat;
		...
		// border: 1px solid red;
			...
			.rank-item {
					...
					.item-price
					{
						...
						.lable{
							...
							.item-text{
								...
								width: 33px;
								height: 27px;
								background: url(@/assets/pcimg/common/arrow_top.png) no-repeat
									center;
				...
				.item-score {
					...
					font-family: 微软雅黑,'微软雅黑','Microsoft Yahei','Microsoft Yahei UI';
					img{
							width: 18px;
							height: 18px;
							margin-bottom: -2px;
